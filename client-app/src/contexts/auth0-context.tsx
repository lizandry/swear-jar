...
export class Auth0Provider extends Component<{}, IState> {
  ...
  // REFACTOR config type is "Auth0ClientOptions", but app won't recognize this type (as documented at https://auth0.github.io/auth0-login/interfaces/auth0clientoptions.html)
  config = {
