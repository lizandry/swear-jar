...
// REFACTOR this code is a little messier than i'd like
interface FormProps {
  user?: User;
  postTeam?: Function;
  visible?: boolean;
      ...
      >
        ...
        >
          <Select 
            ...
            // TODO antdesign docs have an example for "other" option. ability to enter own url or choose from a new set of campaigns would be great
        ...
        <Form.Item
          ...
          name='endDate'
        >
          <DatePicker onChange={(moment, dateString: string)=> {return dateString}}/>
        </Form.Item>
